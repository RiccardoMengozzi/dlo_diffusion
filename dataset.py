...
def load_and_process_sample(file, disp_range=None, rot_range=None):
    dlo_0, dlo_1, obs, action = load_sample_zarr(file)
...
class DloDataset(Dataset):
    def __init__(
        ...
        data_files = glob.glob(os.path.join(dataset_path, "*.zarr"))
...
if __name__ == "__main__":
    # Example usage
    DATA_PATH = "/home/mengo/research/dlo_diffusion/dataset_20250902_161942"
